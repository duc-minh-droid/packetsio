...
export const simulation_add_duplex_link: (a: number, b: number, c: number, d: number, e: number, f: number, g: number) => void;
export const simulation_add_flow: (a: number, b: number, c: number, d: number, e: number, f: number, g: number) => number;
...
export const simulation_clear_flows: (a: number) => void;
...
export const simulation_refresh_routes: (a: number) => void;
export const simulation_remove_flow: (a: number, b: number) => number;
export const simulation_remove_link: (a: number, b: number, c: number) => number;
export const simulation_routing_protocol: (a: number) => [number, number];
export const simulation_run: (a: number, b: number) => number;
export const simulation_set_link_active: (a: number, b: number, c: number, d: number) => number;
export const simulation_set_routing_protocol: (a: number, b: number, c: number) => void;
export const simulation_snapshot: (a: number) => [number, number];
export const simulation_spawn_burst: (a: number, b: number, c: number, d: number) => number;
