...
export class Simulation {
    ...
    add_node(id, kind) {
        ...
        wasm.simulation_add_node(this.__wbg_ptr, id, ptr0, len0);
    }
    /**
     * @returns {number}
     */
     ...
     */
    current_tick() {
        const ret = wasm.simulation_current_tick(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
     * @returns {number}
     */
    delivered() {
        const ret = wasm.simulation_delivered(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
     * @returns {number}
     */
    delivery_rate() {
        const ret = wasm.simulation_delivery_rate(this.__wbg_ptr);
        return ret;
    }
    /**
     * @returns {number}
     */
    dropped() {
        const ret = wasm.simulation_dropped(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
     * @returns {boolean}
     ...
     */
    max_queue_size() {
        const ret = wasm.simulation_max_queue_size(this.__wbg_ptr);
        return ret >>> 0;
    }
    constructor() {
     ...
     */
    ping(from, target_ip) {
        const ptr0 = passStringToWasm0(target_ip, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.simulation_ping(this.__wbg_ptr, from, ptr0, len0);
        return ret !== 0;
    }
    /**
     * @param {number} from
    ...
    snapshot() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.simulation_snapshot(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
    ...
    spawn_packet(from, to) {
        const ret = wasm.simulation_spawn_packet(this.__wbg_ptr, from, to);
        return ret >>> 0;
    }
    step() {
     ...
     */
    throughput() {
        const ret = wasm.simulation_throughput(this.__wbg_ptr);
        return ret;
    }
    /**
     * @returns {number}
     */
    total_packets() {
        const ret = wasm.simulation_total_packets(this.__wbg_ptr);
        return ret >>> 0;
    }
}
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('packetsio_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
